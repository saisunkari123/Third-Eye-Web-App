...
export const Icons = {
  ...
  Settings: ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12.22 2h-.44a2 2 0 0 1-2-2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.73v.51a2 2 0 0 1-1 1.73l-.15.1a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73v.18a2 2 0 0 0 2 0h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.38a2 2 0 0 0-.73-2.73l-.15-.1a2 2 0 0 1-1-1.73v-.51a2 2 0 0 1 1-1.73l.15-.1a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V2.18a2 2 0 0 0-2-2zM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/></svg>
  ),
  ...
  SwitchCamera: ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M11 20A7 7 0 0 1 9.8 6.1C15.7 5 18.5 10 18.5 10" /><path d="M18.5 4v6h-6" /><path d="M13 4A7 7 0 0 1 14.2 17.9C8.3 19 5.5 14 5.5 14" /><path d="M5.5 20v-6h6" /></svg>
  )
};
...
export const MODE_CONFIG = {
  [AppMode.SCENE]: {
    ...
    prompt: "Analyze the scene in front of me. Describe the main objects, people, and context in a medium-length summary (2-3 sentences). Do not be overly verbose. Mention significant obstacles if any.",
    voicePrompt: "Scene mode.",
  },
  [AppMode.PEOPLE]: {
    label: 'People',
    icon: <Icons.Users className="w-8 h-8" />,
    prompt: "Identify people in view. Estimate age, gender, and visible emotion. Describe their position. Keep the description medium length and concise.",
    voicePrompt: "Person mode.",
  },
  [AppMode.OBJECT]: {
    label: 'Object',
    icon: <Icons.Box className="w-8 h-8" />,
    prompt: "List the main objects visible in the image. Be specific about color and type. Keep the list concise and medium length.",
    voicePrompt: "Object mode.",
  },
  [AppMode.TEXT]: {
    label: 'Read',
    icon: <Icons.Type className="w-8 h-8" />,
    prompt: "Read the visible text naturally. If there is a lot of text, provide a summary followed by the full text. If text is cut off, mention it.",
    voicePrompt: "Text mode.",
  },
};